...
public sealed class URP_PixelationRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        URP_PixelationVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<URP_PixelationVolumeComponent>();
